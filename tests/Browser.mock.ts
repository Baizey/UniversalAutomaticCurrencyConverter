...
import {
  ...
  Browsers,
  Environments,
} from '../src/infrastructure/Browser/Browser';
import {
  IBackgroundMessenger,
  RateResponse,
} from '../src/infrastructure/BrowserMessengers/BackgroundMessenger';
...
export class BrowserMock implements IBrowser {
  ...
  constructor() {
    ...
    if (useragent.indexOf('HeadlessChrome') >= 0) this.type = Browsers.Chrome;
    else this.type = Browsers.Firefox;
  }

...
const CurrencyCardTemplate: Story = (args) => (
  <CurrencyCard {...(args as OptionCardProps)} />
);
export const currencyCard = CurrencyCardTemplate.bind({});
currencyCard.args = { symbols: options };

const AccessibilityCardTemplate: Story = (args) => (
  <AccessibilityCard {...(args as OptionCardProps)} />
);
export const accessibilityCard = AccessibilityCardTemplate.bind({});
accessibilityCard.args = { symbols: options };

const VisualCardTemplate: Story = (args) => (
  <VisualsCard {...(args as OptionCardProps)} />
);

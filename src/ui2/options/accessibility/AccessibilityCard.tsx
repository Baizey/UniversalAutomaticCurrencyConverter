...
import {TextInput, useTheme} from '../../atoms'
...
export const DisabledListContainer = (props: PropsWithChildren) => <Div {...props} style={{
    width: '100%',
    maxHeight: '400px',
    overflowY: 'auto',
    overflowX: 'hidden',
...
export const DisabledListItem = (props: DivProps) => {

...
export type CurrencyAmountType = FactoryDi<CurrencyAmountProps, CurrencyAmount>
...
export const CurrencyAmountDi = {currencyAmount: factory<CurrencyAmountProps, CurrencyAmount>(CurrencyAmount)}

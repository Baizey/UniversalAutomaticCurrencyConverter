...
export type CurrencyLocalizationProps = {
    key: string,
    setting: ISetting<string>
}
export type CurrencyLocalizationType = FactoryDi<CurrencyLocalizationProps, CurrencyLocalization>
export type CurrencyLocalizationDi = { currencyLocalization: CurrencyLocalizationType }

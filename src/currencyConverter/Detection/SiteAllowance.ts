...
export class SiteAllowance implements ISiteAllowance {
	...
	private readonly usingWhitelisting: UsingWhitelistingSetting
	private readonly usingBlacklisting: UsingBlacklistingSetting
	...
	constructor( { siteAllowanceConfig }: InfrastructureDi ) {
		...
		this.whitelistedUrls = siteAllowanceConfig.whitelistedUrls
	}

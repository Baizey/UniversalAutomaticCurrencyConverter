...
import { DeleteIcon, Div, ThemeHolder, Title } from '../../atoms'
...
const Container = styled( Div )<ThemeHolder>`
  width: 100%;
  height: fit-content;
  margin: 0;
  background-color: ${ ( props: ThemeHolder ) => props.theme.containerBackground };
`

const Header = styled( Title )<ThemeHolder>``
